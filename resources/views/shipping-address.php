...
<form method='post' action='' onsubmit='saveShippingAddressDetails(event)' id='shipping_address_form' class='shipping_address_form'>
	<h4>Shipping Address</h4> 
		<div class="form-group">
			<label required='required'>Is your Shipping Address same as that of Billing Address</label><br>
			<div class="form-check form-check-inline">
			   <input onclick='showHideShippingAddressBlock()' type='radio' value='yes' class='form-check-input' id='shipping_billing_same_yes' name='shipping_billing_same'>
			   <label class="form-check-label">Yes</label>
		    </div>
		    <div class="form-check form-check-inline">
			    <input onclick='showHideShippingAddressBlock()' type='radio' value='no' class='form-check-input' id='shipping_billing_same_no' name='shipping_billing_same' checked="checked">
			    <label class="form-check-label">No</label>
		    </div><br>
          <span id='shipping_address_block'>
        ...
        <div class='form-group'> 
        	...
        	<button type='button' onclick='loadBillingAddressForm()' class='btn btn-primary float-left' name='voucher_input_back'>Back</button>
        	<button type='submit' class="btn btn-info float-right" name="submit-billing-address" ><i id='loading' class="fa fa-spin fa-spinner" aria-hidden="true"></i> Next</button>
        </div>	
        <br><br>
</form>	
