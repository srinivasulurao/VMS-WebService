...
Route::post('/get-customer-messages','VoucherManagementSystem@GetCustomerMessages')->middleware('authenticate_request');
Route::post('/delete-message','VoucherManagementSystem@DeleteMessage')->middleware('authenticate_request');
Route::post('/delete-product','VoucherManagementSystem@DeleteProduct')->middleware('authenticate_request');
